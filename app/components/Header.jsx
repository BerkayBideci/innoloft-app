                ...
                <div className="flex justify-between items-center">
                    <div className="flex justify-between items-center">
                        <div className="relative mr-[27.875rem]">
                            <input type="text" placeholder="Enter interests, keyword, company name, etc." className="placeholder:text-[#374151] py-1.5 px-2.5 h-7 w-[31.25rem] rounded relative" />
